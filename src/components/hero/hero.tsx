      ...
      <Styled.Wrapper ref={ref} {...rest}>
        <Styled.Body>
          <Styled.Main>
            ...
            <Styled.Details>
              <ButtonFill size="large" href="https://github.com/bemoid/bemoid/">
                Get Started
              </ButtonFill>
          ...
          <Styled.Aside>
            <Styled.Image
              src="/images/bemoid-mascot.svg"
              alt="Bemoid - Robot Mascot"
            />
          </Styled.Aside>
        </Styled.Body>
